 ...
 * still ACTIVE: no bids or reserve-not-met → EXPIRED; otherwise the highest
 * bidder wins and funds move (buyer debited, seller credited minus commission)
 * in one transaction, with both parties notified. Only acts on ACTIVE listings,
 * so re-running is a no-op. Shared by the admin manual trigger and the cron.
 */
