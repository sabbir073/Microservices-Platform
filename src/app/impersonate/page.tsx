...
function ImpersonateInner() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-(--app-page)">
      <div className="bg-(--app-surface) rounded-xl border border-(--app-line) p-8 max-w-md w-full mx-4">
        <div className="text-center">
          {isLoading ? (
            <>
              <Loader2 className="w-12 h-12 text-(--app-accent-ink) animate-spin mx-auto mb-4" />
            ...
            <>
              ...
              <button
                ...
                className="px-4 py-2 bg-(--app-surface-2) text-(--app-ink) rounded-lg hover:bg-(--app-surface-hover) transition-colors"
              >
                Back to Users
              </button>
            </>
