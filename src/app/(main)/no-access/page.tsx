...
export default function NoAccessPage() {
  return (
    <div className="min-h-[60vh] flex flex-col items-center justify-center text-center px-6">
      ...
      <p className="text-(--app-ink-3) text-sm mt-2 max-w-sm">
        This page isn&apos;t available on your account. If you think this is a
        mistake, contact support.
      </p>
      <Link
        href="/dashboard"
        className="mt-6 inline-flex items-center gap-1.5 px-5 py-2.5 rounded-lg bg-(--app-cta) hover:bg-(--app-cta) text-(--app-on-cta) text-sm font-bold"
      >
