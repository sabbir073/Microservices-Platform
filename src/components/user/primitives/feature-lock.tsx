      ...
      <div className="rounded-2xl border border-(--app-line) bg-(--app-surface) p-6 text-center">
        ...
        <div className="mt-4 flex flex-col sm:flex-row items-center justify-center gap-2">
          {!message && applyHref && (
            <Link
              href={applyHref}
              className="inline-flex items-center justify-center gap-1.5 px-4 py-2.5 rounded-lg bg-(--app-cta) hover:bg-(--app-cta) text-(--app-on-cta) text-sm font-bold active:scale-[0.97] transition-transform"
            >
              Apply for access
