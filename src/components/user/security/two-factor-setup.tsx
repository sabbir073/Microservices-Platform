...
export function TwoFactorSetup() {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="rounded-2xl border border-(--app-line) bg-(--app-surface) p-4 space-y-4">
        ...
        {data ? (
          <>
            ...
            <div>
              <p className="text-[10px] uppercase tracking-wider font-bold text-(--app-ink-3) mb-1">
                Or enter manually
              </p>
